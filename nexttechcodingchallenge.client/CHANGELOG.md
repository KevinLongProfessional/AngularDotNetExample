...
- Create Angular project with ng: `ng new nexttechcodingchallenge.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`nexttechcodingchallenge.client.esproj`).
