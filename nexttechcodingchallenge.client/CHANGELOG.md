...
- Create Angular project with ng: `ng new hackernewsKevinLong.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`hackernewsKevinLong.client.esproj`).
